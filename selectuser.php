...
if(isset($_POST['submit']))
{
    ...
    if (($amount)<0)
   {
        ...
        echo ' alert("Negative values not accepted!!")';  // showing an alert box.
        echo '</script>';
    }
    ...
    // constraint to check zero values
         ...
         echo '<script type="text/javascript">';
         echo 'alert("Zero amount is not allowed")';
         echo '</script>';
     }
                ...
                $sender = $sql1['NAME'];
                $receiver = $sql2['NAME'];
                //echo $date.$sender.$receiver;
                $sql = "INSERT INTO transfer (form_id, to_id, amount) VALUES ('$sender','$receiver','$amount')";
                $query=mysqli_query($conn,$sql) ;
